...
set helplang=en
set ruler
set runtimepath=~/.vim,~/.vim/plugged/rust.vim/,~/.vim/plugged/tagbar/,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,~/.vim/plugged/rust.vim/after,~/.vim/after
set shiftwidth=2
...
normal! 0
tabnext
edit kernel/arch/i386/isrirq.S
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 469 - ((45 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
469
normal! 06|
tabnext
edit kernel/arch/i386/syscall.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 135 - ((36 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
135
...
tabnext 4
set stal=1
badd +0 kernel/arch/i386/gdt.c
badd +0 kernel/arch/i386/isrirq.S
badd +0 kernel/arch/i386/syscall.c
badd +0 kernel/kernel/kernel.c
badd +0 kernel/arch/i386/timer.c
